        ...
        child: SizedBox(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Text('مسح القائمة المفضلة',
                ...
                Center(
                  child: Text(
                    'هل انت متأكد انك تريد مسح جميع المنتجات فى القائمة المفضلة ؟',
                    style: GoogleFonts.cairo(
                        fontSize: 14.sp,
                        fontWeight: FontWeight.w500,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TextButton(
                        onPressed: () {
                          Navigator.of(context).pop();
                          BlocProvider.of<AddProductToFavoritListCubit>(context).removeAllFavoritList();
                        },
                        style: TextButton.styleFrom(
