...
class CardItemForSimilar extends StatefulWidget {
  const CardItemForSimilar({super.key});

  @override
  State<CardItemForSimilar> createState() => _CardItemForSimilarState();
}

class _CardItemForSimilarState extends State<CardItemForSimilar> {
